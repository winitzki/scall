...
public class dhallLexer extends Lexer {
	...
	public static final int
		...
		SUB_DELIMS=185, HEXDIG64=186, HEXDIG16=187, HEXDIG4=188;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__147", "T__148", "T__149", "T__150", "T__151", "END_OF_LINE", "VALID_NON_ASCII", 
			"TAB", "PRINTABLE_ASCII", "BLOCK_COMMENT_CHAR", "NOT_END_OF_LINE", "ALPHA", 
			"DIGIT", "ALPHANUM", "HEXDIG", "END_OF_TEXT_LITERAL", "IF", "THEN", "ELSE", 
			"LET", "IN", "AS", "USING", "MERGE", "MISSING", "INFINITY", "NAN", "KEYWORDSOME", 
