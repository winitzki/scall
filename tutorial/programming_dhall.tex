...
\lstset{language=Haskell,
    ...
    morekeywords={[2]{String,Short,Type,Kind,Sort,Bool,Double,Float,BigDecimal,Seq,Map,Set,Option,Either,Future,Successful,LazyList,Vector,Range,IndexedSeq,True,False,None,List,Nil,Try,Success,Failure,Some,Left,Right,Nothing,Any,Array,Unit,Iterator,Stream,Throwable,Integer,Object}},
