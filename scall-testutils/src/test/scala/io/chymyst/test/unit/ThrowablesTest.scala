...
class ThrowablesTest extends FunSuite {
  test("print throwables, stack traces, and causes") {
    ...
    expect(
      ...
      result2 contains "at io.chymyst.test.unit.ThrowablesTest.$anonfun$new$1(ThrowablesTest.scala:12)",
      result2 contains "Caused by: java.lang.Exception: test1",
      result2 contains "at io.chymyst.test.unit.ThrowablesTest.$anonfun$new$1(ThrowablesTest.scala:11)",
    )

    expect(
      result3 contains "java.lang.Exception: test3",
      result3 contains "at io.chymyst.test.unit.ThrowablesTest.$anonfun$new$1(ThrowablesTest.scala:13)",
      result3 contains "java.lang.Exception: test2",
      result3 contains "at io.chymyst.test.unit.ThrowablesTest.$anonfun$new$1(ThrowablesTest.scala:12)",
      result3 contains "Caused by: java.lang.Exception: test1",
      result3 contains "at io.chymyst.test.unit.ThrowablesTest.$anonfun$new$1(ThrowablesTest.scala:11)",
    )
  }
